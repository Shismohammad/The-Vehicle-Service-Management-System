...
public class ServiceCenterController {
	...
	public ServiceCenter save(@RequestBody ServiceCenterRegistration servicecenter)
	{
		...
		String encrypted=PassBasedEnc.generateSecurePassword(servicecenter.getPassword(),saltValue.getSalt());
		
		Login login =new Login(servicecenter.getUserid(),encrypted,servicecenter.getAnswer(),false,role,questionid);
