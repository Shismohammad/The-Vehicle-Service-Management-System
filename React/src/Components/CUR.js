        ...
        <form>
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => {
                validate("companyname", e.target.value);
              }}
            />
            <div
              id="emailHelp"
              ...
              style={{
                display:
                  !info.companyname.valid && info.companyname.touched
                    ? "block"
                    : "none",
              }}
            >
          ...
          <div className="form-group">
            ...
            <div
              ...
              style={{
                display:
                  !info.regno.valid && info.regno.touched ? "block" : "none",
              }}
            >
              {info.regno.error}
            </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              name="addressline"
              value={info.addressline.value}
              onChange={(e) => {
                validate("addressline", e.target.value);
              }}
            />
            <div
              id="emailHelp"
              ...
              style={{
                display:
                  !info.addressline.valid && info.addressline.touched
                    ? "block"
                    : "none",
              }}
            >
          ...
          <div className="form-group">
            ...
            <div
              ...
              className="form-text"
              style={{
                display: !info.ans.valid && info.ans.touched ? "block" : "none",
              }}
            >
              {info.ans.error}
            </div>
          ...
          <div className="form-group">
            ...
            <div
              ...
              style={{
                display:
                  !info.email.valid && info.email.touched ? "block" : "none",
              }}
            >
              {info.email.error}
            </div>
